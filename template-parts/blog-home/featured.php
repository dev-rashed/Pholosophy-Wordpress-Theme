                ...
                <div class="entry" style="background-image:url('<?php echo esc_url($post_data[0]['thumbnail']) ?>');">
                    ...
                    <div class="entry__content">
                        ...
                        <div class="entry__info">
                            <a href="<?php echo esc_url($post_data[0]['author_posts']) ?>" class="entry__profile-pic">
                                <img class="avatar" src="<?php echo esc_url($post_data[0]['author_avatar']) ?>" alt="">
                            </a>

                            <ul class="entry__meta">
                                <li><a
                                        href="<?php echo esc_url($post_data[0]['author_posts']) ?>"><?php echo esc_html($post_data[0]['author']) ?></a>
                                </li>
            ...
            <div class="featured__column featured__column--small">
                ...
                <div class="entry" style="background-image:url('<?php echo esc_url($post_data[$i]['thumbnail']) ?>');">
                    ...
                    <div class="entry__content">
                        ...
                        <div class="entry__info">
                            <a href="<?php echo esc_url($post_data[$i]['author_posts']) ?>" class="entry__profile-pic">
                                <img class="avatar" src="<?php echo esc_url($post_data[$i]['author_avatar']) ?>" alt="">
                            </a>

                            <ul class="entry__meta">
                                <li><a
                                        href="<?php echo esc_url($post_data[$i]['author_posts']) ?>"><?php echo esc_html($post_data[$i]['author']) ?></a>
                                </li>
