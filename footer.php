    ...
    <div class="row top">
        ...
        <div class="col-eight md-six tab-full popular">
            ...
            <div class="block-1-2 block-m-full popular__posts">
                <?php $philosophy_popular_posts = new WP_Query(array(
                    'posts_per_page'        => 6,
                ...
                <article class="col-block popular__post">
                    ...
                    <section class="popular__meta">
                        <span class="popular__author"><span><?php _e('By', 'philosophy') ?></span><a
                                href="<?php get_author_posts_url( get_the_author_meta('ID') ) ?>"><?php the_author(); ?></a></span>
                        <span class="popular__date"><span><?php _e('on', 'philosophy') ?></span> <time
                                datetime="<?php the_date(); ?>"><?php echo get_the_date() ?></time></span>
                    </section>
                </article>
